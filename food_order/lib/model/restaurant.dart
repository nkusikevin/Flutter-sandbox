...
import 'package:food_order/model/cart_item.dart';
...
class Restaurant extends ChangeNotifier {
  ...
  final List<Food> _menu = [
    ...
    Food(
      ...
      imagePath: 'images/burger/burger3.jpg',
      price: 4.99,
      category: FoodCategory.Burger,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.50),
    ...
    Food(
      ...
      imagePath: 'images/burger/burger4.jpg',
      price: 7.99,
      category: FoodCategory.Burger,
      availableAddons: [
        Addon(name: 'Extra Cheese', price: 0.50),
    ...
    Food(
      ...
      imagePath: 'images/salad/salad1.jpg',
      price: 3.99,
    ...
    Food(
      ...
      imagePath: 'images/salad/salad2.jpg',
      price: 4.99,
      category: FoodCategory.Salads,
      availableAddons: [
        Addon(name: 'Grilled Chicken', price: 2.50),
    ...
    Food(
      ...
      description:
          'Lettuce, tomato, cucumber, onions, olives, feta cheese, vinaigrette',
      imagePath: 'images/salad/salad3.jpg',
      price: 5.99,
      category: FoodCategory.Salads,
      availableAddons: [
        Addon(name: 'Grilled Chicken', price: 2.50),
    ...
    Food(
      ...
      description:
          'Lettuce, tomato, cucumber, onions, olives, feta cheese, vinaigrette',
      imagePath: 'images/salad/salad4.jpg',
      price: 6.99,
      category: FoodCategory.Salads,
      availableAddons: [
        Addon(name: 'Grilled Chicken', price: 2.50),
    ...
    Food(
      ...
      imagePath: 'images/side/sides1.jpg',
      price: 1.99,
    ...
    Food(
      ...
      imagePath: 'images/side/sides2.jpg',
      price: 2.99,
      category: FoodCategory.Sides,
      availableAddons: [
        Addon(name: 'Cheese', price: 0.50),
    ...
    Food(
      ...
      imagePath: 'images/dessert/dessert1.jpg',
      price: 3.99,
    ...
    Food(
      ...
      imagePath: 'images/dessert/dessert2.jpg',
      price: 4.99,
      category: FoodCategory.Desserts,
      availableAddons: [
        Addon(name: 'Vanilla Ice Cream', price: 1.50),
    ...
    Food(
      ...
      imagePath: 'images/dessert/dessert3.jpg',
      price: 5.99,
      category: FoodCategory.Desserts,
      availableAddons: [
        Addon(name: 'Vanilla Ice Cream', price: 1.50),
    ...
    Food(
      ...
      imagePath: 'images/drink/drinks1.jpg',
      price: 1.99,
    ...
    Food(
      ...
      imagePath: 'images/drink/drinks2.jpg',
      price: 1.99,
      category: FoodCategory.Drinks,
      availableAddons: [
        Addon(name: 'Cherry Syrup', price: 0.50),
